...
# ============================================================================
# Privado: ranking a partir de clean.mv_escolas_scores
# ============================================================================
...
sub _rank_from_mv ($self, $cod_inep, $indicator_id, $def, $include_national, $network) {
  ...
  return $self->_format_result($indicator_id, $def, $year, $row, $network);
}

# ============================================================================
# Privado: ranking a partir de clean.ideb_notas_escolas
# ============================================================================
...
sub _assert_known_column ($self, $column) {
  ...
  croak "Coluna não registrada em indicator_registry: $column" unless $known{$column};
  return $column;
}
...
sub _format_result ($self, $indicator_id, $def, $year, $row, $network) {
