...
=head1 TABLE: C<clean.remuneracao_municipal>

=cut

__PACKAGE__->table("clean.remuneracao_municipal");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:mMtcUw/+6xL07ZAEfphdkg
