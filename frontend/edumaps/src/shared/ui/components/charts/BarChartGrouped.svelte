<script>
  // src/shared/ui/components/charts/BarChartGrouped.svelte
  import { onMount, onDestroy } from "svelte";
  import { BarChartGrouped as CarbonBarChartGrouped } from "@carbon/charts-svelte";
...
<div bind:this={holder} class="relative w-full overflow-hidden {className}" style:height>
  <CarbonBarChartGrouped data={data} options={chartOptions} />
</div>